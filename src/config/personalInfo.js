...
const personalInfo = {
  ...
  cv: '/cv',
  repo: 'https://github.com/anayy09/human-signal-portfolio',
  ...
  publications: [
    ...
    },
    {
      ...
      venue:
        'International Journal of Advances in Signal and Image Sciences (IJASIS), vol. 12',
      year: 'Feb 2026',
      description:
    ...
    },
    {
      ...
      venue:
        '2025 IEEE International Conference on Contemporary Computing and Communications (InC4)',
      year: 'Dec 2025',
      description:
  ...
  patents: [
    {
      ...
      grants: [
        {
          label: 'German Utility Model',
          number: 'DE 20 2026 101 701 U1',
          status: 'Granted',
          date: 'Apr 2026',
        },
        {
          label: 'Indian Application',
          number: '202611027418',
          status: 'Published',
          date: 'May 2026',
        },
  ...
  awards: [
    {
      title: 'Gold Medal · Best Outgoing Student, B.Tech CSE',
    ...
    {
      title: 'Runner-Up · National Startup Day Exhibition',
      org: 'AIC-JKLU',
      year: '2022',
    },
  ],
  ...
  itinerary: [
    { placeId: 'place-2', year: '2003', label: 'Origin' },
    {
      placeId: 'place-1',
      year: '2021',
      label: 'B.Tech · JK Lakshmipat University',
    },
    ...
    { placeId: 'place-26', year: '2024', label: 'Exchange · IIT Kanpur' },
    {
      placeId: 'place-8',
      year: '2024',
      label: 'Research Intern · SVNIT Surat',
    },
    ...
    { placeId: 'place-5', year: '2024', label: 'RA · SBILab, IIIT Delhi' },
    {
      placeId: 'place-50',
      year: '2025',
      label: 'MS CS · University of Florida',
      current: true,
    },
  ],
  ...
  visitedPlaces: [
    ...
    },
    {
      ...
      story: 'Semester Exchange at IIT Gandhinagar',
    },
    {
      id: 'place-8',
      name: 'Surat, India',
      coordinates: [72.8317058, 21.2094892],
      story: 'Research internship at SVNIT',
    },
    {
      id: 'place-10',
      name: 'Mumbai, India',
    ...
    },
    {
      ...
      story: 'Research internship at IIT Jammu',
    },
    {
      id: 'place-34',
      name: 'Srinagar, India',
